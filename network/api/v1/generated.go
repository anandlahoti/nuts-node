...
type ListTransactionsParams struct {
	// Lamport Clock value from where to start (inclusive). Default = 0.
	Start *int `form:"start,omitempty" json:"start,omitempty"`

	// Lamport Clock value where to stop (exclusive). Returns everything after `start` when omitted. Must be larger than the `start` parameter.
	End *int `form:"end,omitempty" json:"end,omitempty"`
}
